...
export default function WelcomeScreen() {
  return (
    <ImageBackground
      ...
      source={require("C:/Users/Mshari/Desktop/ReactNative project/AwesomeProject2/AwesomeProject2/assets/stars.jpg")}
    >
      <View style={styles.logoCon}>
        <Text style={styles.WelText}>"Ready?{"\n"}let's take your size"</Text>
      </View>

      <TouchableOpacity style={styles.LoginButton}>
        <Text style={styles.LoginText} onPress={() => console.log("login")}>
          تسجيل الدخول{" "}
        </Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.RegButton}>
        <Text style={styles.RegText} onPress={() => console.log("Regs")}>
          {" "}
          تسجيل{" "}
        </Text>
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  logo: {
    ...
    shadowOpacity: 1,
  }, //الاربع خصائض الاخيرة الظل لأبل
  text: {
    fontSize: 30,
